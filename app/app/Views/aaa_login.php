...
<head>
	...
	<link href="<?= base_url() ?>/___/css/bootstrap.css" rel="stylesheet">
	<link href="<?= base_url() ?>/___/css/style.css" rel="stylesheet">
</head>
...
<body>
	...
	<script src="<?= base_url() ?>/___/js/jquery-1.11.3.min.js"></script>
	<script src="<?= base_url() ?>/___/js/bootstrap.js"></script>
	<script type="text/javascript">
		base_url = "<?= base_url() ?>";
		uri_js = "<?= URI_JS ?>";
	</script>
	<script src="<?= base_url() ?>/___/js/aplikasi.js"></script>
</body>
