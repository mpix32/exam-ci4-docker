          ...
          <div id="konfirmasi"></div>
            ...
            <div class="form-group" style="margin-top: 20px">
              <div class="col-md-12">
                ...
                <a href="<?php echo base_url(); ?>adm/m_soal/pilih_mapel/<?php echo $d['id_mapel']?$d['id_mapel']:0; ?>" class="btn btn-default"><i class="fa fa-minus-circle"></i> Kembali</a>
              </div>
            </div>
      </form>
    </div><!-- panel body-->
