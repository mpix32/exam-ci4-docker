<div class="row col-md-12 ini_bodi">
  <div class="panel panel-info">
    <div class="panel-heading">Data HRD
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 id="myModalLabel">Data HRD</h4>
      </div>
        ...
        <form name="f_guru" id="f_guru" onsubmit="return m_guru_s();">
          ...
          <table class="table table-form">
            <tr>
              ...
              <td style="width: 75%"><input type="text" class="form-control" name="nip" id="nip" minlength="16" maxlength="16"></td>
            </tr>
            <tr>
