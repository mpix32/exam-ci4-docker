        ...
        <form name="f_ujian" id="f_ujian" onsubmit="return m_ujian_s();">
          ...
          <table class="table table-form">
            ...
            <tr>
              ...
              <td><?php echo form_dropdown('mapel', $p_mapel, '', 'onchange="return __ambil_jumlah_soal(this.value);" class="form-control"  id="mapel" required'); ?></td>
            </tr>
            <tr>
              <td>Jumlah soal</td>
            ...
            <tr>
              <td>Keterlambatan</td>
              <td><?php echo form_input('terlambat', '', 'class="form-control" id="terlambat" placeholder="menit" required style="width: 100px; display: inline; float: left"'); ?> <div style="float: left; margin: 4px 0 0 10px"> menit</div>
              </td>
            </tr>
            <tr>
              <td>Acak Soal</td>
