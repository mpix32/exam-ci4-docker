        ...
        <form name="f_siswa" id="f_siswa" onsubmit="return m_siswa_s();">
          ...
          <table class="table table-form">
            ...
            <tr>
              ...
              <td style="width: 75%"><input type="text" class="form-control" name="nim" id="nim" required minlength="16" maxlength="16"></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td style="width: 75%"><input type="date" class="form-control" name="tgl_lahir" id="tgl_lahir" required></td>
            </tr>
          </table>
      </div>
