...
<head>
    <meta charset="utf-8">
    <title>Dashboard - <?php echo NAMA_APLIKASI . " " . VERSI ?></title>
...
<body>
    ...
    <nav class="navbar navbar-findcond navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand"><i class="fa fa-home"></i> <?php echo NAMA_APLIKASI . " " . VERSI ?></a>
            </div>
    ...
    <div class="container col-md-12" style="margin-top: 70px">
        <span>
            <h3 style="text-align : center;"><?php echo $nama_ujian; ?></h3>
        </span>
        <div class="col-md-9">
    ...
    <div class="col-md-12" style="border-top: solid 4px #ddd; text-align: center; padding-top: 10px; margin-top: 50px; margin-bottom: 20px">
        &copy; 2017 <a href="<?php echo base_url(); ?>adm"><?php echo NAMA_APLIKASI . " " . VERSI . "</a> <br> Waktu Server: " . tjs(date('Y-m-d H:i:s'), "s") . " - Waktu Database: " . tjs(waktu_sql(), "s"); ?>.
    </div>
